...
---
title: "`r paste(model_name, sub("^[^-]+-(.*)$", "\\1", sub("\\.git$", "", basename(git2r::remote_url(here::here())))), sep = " - ")`"
date: "`r Sys.time()`"
...
SciViews::R
library(mlearning)
# TODO: get repos from Git data. Otherwise, we got the folder name that the student has chosen!
repos <- sub("\\.git$", "", 
...
write$rds(results, file.path("/media/sf_downloads", res_file))
